...
from transformer_networks.pvtv2 import pvt_v2_b2
import numpy as np
...
def load_weights(encoder):
    try:
        path = "/path/to/models_weights/pvt_v2_b2.pth" #weights pretrained on imagenet
        #download from https://github.com/whai362/PVT/releases/download/v2/pvt_v2_b2.pth
...
def build_depth(img_size):
    encoder = pvt_v2_b2(img_size=np.array(img_size))

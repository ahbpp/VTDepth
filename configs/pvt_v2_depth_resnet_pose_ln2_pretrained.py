...
from transformer_networks.pvtv2 import PyramidVisionTransformerV2
import numpy as np
...
def build_depth(img_size):
    ...
    decoder = networks.UpdatedDepthDecoderLighter2(encoder.embed_dims,
                                                   num_ch_dec=np.array([64, 128, 160, 256]),
                                                   reduce_last=True)
